      ...
      <style>
        *,
        ...
        html {
          ...
          -moz-tab-size: 4;
          tab-size: 4;
          font-family: ui-sans-poppins, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-poppins, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
