    ...
    Plugin.prototype.isVideo = function(src, index) {
        ...
        if (!src) {
            if (html) {
                ...
                console.error('lightGallery :- data-src is not provided on slide item ' + (index + 1) + '. Please make sure the selector property is properly configured. More info - http://sachinchoolur.github.io/lightGallery/demos/html-markup.php');
                return false;
            }
        }
