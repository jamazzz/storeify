...
(function (global, factory) {
  ...
  var pointInRegion = function (point, region) {
      ...
      // http://www.ecse.rpi.edu/Homepages/wrf/Research/Short_Notes/pnpoly.php
  ...
  ChartInternal.prototype.showTooltip = function (selectedData, element) {
      ...
      $$.tooltip
          .php(config.tooltip_contents.call($$, selectedData, $$.axis.getXAxisTickFormat(), $$.getYFormat(forArc), $$.color))
          .style('display', 'block');
