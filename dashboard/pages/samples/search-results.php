                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-12 mb-5">
                        <h2>Search Result For<u class="ms-2">"Bootstrapdash"</u></h2>
                        <p class="text-muted">About 12,100 results (0.52 seconds)</p>
                      </div>
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">Bootstrapdash</a>
                      ...
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">Bootstrapdash Team – Medium</a>
                          <a class="page-url text-primary" href="#">https://medium.com/@bootstrapdash</a>
                      ...
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">Bootstrapdash · GitHub</a>
                          <a class="page-url text-primary" href="#">https://github.com/bootstrapdash</a>
                          <p class="page-description mt-1 w-75 text-muted">Bootstrapdash has 1 repository available. Follow their code on GitHub.</p>
                        </div>
                      </div>
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">bootstrapdash.com - Home | Facebook</a>
                          <a class="page-url text-primary" href="#">https://www.facebook.com/bootstrapdash</a>
                      ...
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">Bootstrapdash Team – Hacker Noon</a>
                          <a class="page-url text-primary" href="#">https://hackernoon.com/@bootstrapdash</a>
                      ...
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">Bootstrapdash | Crunchbase</a>
                          <a class="page-url text-primary" href="#">https://www.crunchbase.com/organization/bootstrapdash</a>
                      ...
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          <a class="d-block h4 mb-0" href="#">Bootstrapdash.com (@bootstrapdash) | Twitter</a>
                          <a class="page-url text-primary" href="#">https://twitter.com/@bootstrapdash</a>
                      ...
                      <div class="col-12 results">
                        <div class="pt-4 border-bottom">
                          ...
                          <a class="page-url text-primary" href="#">https://www.behance.net/bootstrapdash</a>
