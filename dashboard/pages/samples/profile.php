                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        ...
                        <div class="border-bottom py-4">
                          <p>Skills</p>
                          <div>
                            <label class="badge badge-outline-light my-1">Chalk</label>
                            <label class="badge badge-outline-light my-1">Hand lettering</label>
                            <label class="badge badge-outline-light my-1">Information Design</label>
                            <label class="badge badge-outline-light my-1">Graphic Design</label>
                            <label class="badge badge-outline-light my-1">Web Design</label>
                          </div>
                        </div>
                        <div class="border-bottom py-4">
