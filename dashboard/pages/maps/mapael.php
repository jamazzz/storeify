...
<html lang="en">
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Mapael </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Maps</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Mapael</li>
                </ol>
              </nav>
            </div>
            <div class="row">
    ...
    <script src="../../../assets/vendors/jquery-mapael/world_countries.min.js"></script>
    <script src="../../../assets/vendors/jquery-mapael/usa_states.min.js"></script>
    ...
    <script src="../../../assets/js/mapael_example_1.js"></script>
    <script src="../../../assets/js/mapael_example_2.js"></script>
