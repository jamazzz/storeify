            ...
            <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <!-- Modal starts -->
                    <div class="text-center">
                      <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal-3">Click for demo<i class="mdi mdi-play-circle ms-1"></i></button>
                    </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Varying Modal Content</h4>
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal-4" data-whatever="@getbootstrap">Open modal for @getbootstrap</button>
                  </div>
                </div>
              </div>
            </div>
