...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../../assets/vendors/jquery-contextmenu/jquery.contextMenu.min.css">
  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Context menu </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">UI Elements</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Context menu</li>
                </ol>
              </nav>
            </div>
            <div class="row">
    ...
    <script src="../../../assets/vendors/jquery-contextmenu/jquery.contextMenu.min.js"></script>
