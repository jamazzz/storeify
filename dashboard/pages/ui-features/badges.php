                  ...
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      <table class="table mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td class="ps-0">Primary label</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-primary">Primary</div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Info label</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-info">Info</div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Danger label</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-danger">Danger</div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Success label</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-success">Success</div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Warning label</td>
                            <td class="pe-0 text-end">
                  ...
                  <div class="card-body">
                    ...
                    <div class="template-demo">
                      <table class="table mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td class="ps-0">Icon Badge</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-pill badge-primary"><i class="mdi mdi-account"></i></div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Outlined Icons</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-pill badge-outline-info"><i class="mdi mdi-cloud-outline"></i></div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Icon With Text</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-pill badge-danger"><i class="mdi mdi-email me-2"></i>12</div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Icon With Text</td>
                            <td class="pe-0 text-end">
                              <div class="badge badge-pill badge-success">12<i class="mdi mdi-email ms-2"></i></div>
                            </td>
                          </tr>
                          <tr>
                            <td class="ps-0">Icon Badge</td>
