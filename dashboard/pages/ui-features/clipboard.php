                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="card-body">
                        ...
                        <div class="mt-3">
                          <button type="button" class="btn btn-inverse-primary btn-clipboard" data-clipboard-action="copy" data-clipboard-target="#clipboardExample1">Copy</button>
                          <button type="button" class="btn btn-inverse-success btn-clipboard" data-clipboard-action="cut" data-clipboard-target="#clipboardExample1">Cut</button>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="card-body">
                        ...
                        <div class="mt-3">
                          <button type="button" class="btn btn-inverse-primary btn-clipboard" data-clipboard-action="copy" data-clipboard-target="#clipboardExample2">Copy</button>
                          <button type="button" class="btn btn-inverse-success btn-clipboard" data-clipboard-action="cut" data-clipboard-target="#clipboardExample2">Cut</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="card-body">
                        ...
                        <div class="mt-3">
                          <button type="button" class="btn btn-inverse-primary btn-clipboard" data-clipboard-action="copy" data-clipboard-target="#clipboardExample3">Copy</button>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="card-body">
                        ...
                        <div class="card card-inverse-primary">
                          <div class="card-body">
                            <p> Lorem ipsum <span class="bg-info" id="clipboardExample4">dolor sit amet</span>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                          </div>
                        </div>
                        <div class="mt-3">
                          <button type="button" class="btn btn-inverse-primary btn-clipboard" data-clipboard-action="copy" data-clipboard-target="#clipboardExample4">Copy highlighted text</button>
                        </div>
                      </div>
                    </div>
                  </div>
