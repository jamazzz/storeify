                        ...
                        <div id="dragula-left" class="py-2">
                          <div class="card rounded border mb-2">
                            <div class="card-body p-3">
                              <div class="media">
                                <i class="mdi mdi-cellphone-link icon-sm align-self-center me-3"></i>
                                <div class="media-body">
                          ...
                          <div class="card rounded border mb-2">
                            <div class="card-body p-3">
                              <div class="media">
                                <i class="mdi mdi-upload icon-sm align-self-center me-3"></i>
                                <div class="media-body">
                          ...
                          <div class="card rounded border mb-2">
                            <div class="card-body p-3">
                              <div class="media">
                                <i class="mdi mdi-airplane icon-sm align-self-center me-3"></i>
                                <div class="media-body">
                      ...
                      <div class="col-md-6">
                        ...
                        <div id="dragula-event-left" class="py-2">
                          <div class="card rounded border mb-2">
                            <div class="card-body p-3">
                              <div class="media">
                                <i class="mdi mdi-check icon-sm text-primary align-self-center me-3"></i>
                                <div class="media-body">
                                  <h6 class="mb-1">Build wireframe</h6>
                                  <p class="mb-0 text-muted"> Build wireframe for the new app </p>
                                </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div id="dragula-event-right" class="py-2">
                          <div class="card rounded border mb-2">
                            <div class="card-body p-3">
                              <div class="media">
                                <i class="mdi mdi-check-all icon-sm text-success align-self-center me-3"></i>
                                <div class="media-body">
                                  <h6 class="mb-1">Project details</h6>
                                  <p class="mb-0 text-muted"> Get new project details from Greg </p>
                                </div>
