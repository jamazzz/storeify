              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="file" class="dropify" data-default-file="../../images/samples/1280x768/2.jpg" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <input type="file" class="dropify" data-height="300" data-default-file="../../images/samples/1280x768/3.jpg" />
                  </div>
                </div>
              </div>
            </div>
