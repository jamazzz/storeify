                ...
                <ul class="grid gap-sm lg:flex lg:justify-center">
                  ...
                  <li class="relative ">
                    ...
                    <ul class="dropdown-menu grid gap-xs relative w-full shadow-none rounded-btn rounded-t-none border-t max-w-full transition border-background-accent lg:w-[350px] lg:max-w-[500px] lg:absolute lg:rounded-btn lg:border-none lg:translate-y-2 lg:shadow-lg lg:shadow-[rgba(0,0,0,.3)]" style="display:none;">
                      <li class="group">
                        <a href="/category/general" class="type-header py-sm px-sm transition rounded-btn block w-full hover:bg-background-accent">
                          GENERAL
                        </a>
                      </li>
                      <li class="group">
                        <a href="/category/jobs" class="type-header py-sm px-sm transition rounded-btn block w-full hover:bg-background-accent">
                          JOBS
                        </a>
                      </li>
                      <li class="group">
                        <a href="/category/illegal" class="type-header py-sm px-sm transition rounded-btn block w-full hover:bg-background-accent">
                          ILLEGAL
                        </a>
                      </li>
                      <li class="group">
          ...
          <div>
            ...
            <section class="bg-background-accent rounded p-lg mt-grid">
              ...
              <div class="flex flex-wrap gap-grid">
                ...
                <div class="bg-background rounded p-lg grid gap-md flex-[1_1_300px] grid-rows-[auto_1fr]">
                  <div class="flex gap-md items-center">
                    <img src="https://media.discordapp.net/attachments/1049749773185470537/1135266178688876595/avatar.png" alt="Avatar of furrycarrot" class="rounded-sm h-12">
                    <div class="flex-grow">
                      <h3 class="type-header block leading-none">furrycarrot</h3>
                      <small class="type-subtitle text-foreground-accent opacity-50 block">@furrycarrot</small>
                    </div>
                    <small class="type-subtitle text-foreground-accent opacity-50 block">Discord</small>
                  </div>
                  <div>
                    ...
                    <p class="type-paragraph text-foreground-accent">m-insurance V2, The script is amazing and the support on it has been fantastic!! Can’t wait to see what else y’all have in store for the community</p>
                  </div>
                </div>
                <div class="bg-background rounded p-lg grid gap-md flex-[1_1_300px] grid-rows-[auto_1fr]">
                  <div class="flex gap-md items-center">
                    <img src="https://media.discordapp.net/attachments/1049749773185470537/1135266178688876595/avatar.png" alt="Avatar of gideon11" class="rounded-sm h-12">
                    <div class="flex-grow">
                      <h3 class="type-header block leading-none">gideon11</h3>
                      <small class="type-subtitle text-foreground-accent opacity-50 block">@gideon11</small>
                    </div>
                    <small class="type-subtitle text-foreground-accent opacity-50 block">Discord</small>
                  </div>
                  <div>
                    ...
                    <p class="type-paragraph text-foreground-accent">Thanks guys for the assist I highly recommend you to my friends who making services</p>
                  </div>
                </div>
                <div class="bg-background rounded p-lg grid gap-md flex-[1_1_300px] grid-rows-[auto_1fr]">
                  <div class="flex gap-md items-center">
                    <img src="https://media.discordapp.net/attachments/1049749773185470537/1135266178688876595/avatar.png" alt="Avatar of johntookflight" class="rounded-sm h-12">
                    <div class="flex-grow">
                      <h3 class="type-header block leading-none">johntookflight</h3>
                      <small class="type-subtitle text-foreground-accent opacity-50 block">@johntookflight</small>
                    </div>
                    <small class="type-subtitle text-foreground-accent opacity-50 block">Discord</small>
                  </div>
                  <div>
                    ...
                    <p class="type-paragraph text-foreground-accent">Good man quality Scripts the best support around.. all around good guy if you are thinking about buying from him do so you won’t regret it 10/10!</p>
                  </div>
                </div>
                <div class="bg-background rounded p-lg grid gap-md flex-[1_1_300px] grid-rows-[auto_1fr]">
                  <div class="flex gap-md items-center">
                    <img src="https://media.discordapp.net/attachments/1049749773185470537/1135266178688876595/avatar.png" alt="Avatar of whatsnext167" class="rounded-sm h-12">
                    <div class="flex-grow">
                      <h3 class="type-header block leading-none">whatsnext167</h3>
                      <small class="type-subtitle text-foreground-accent opacity-50 block">@whatsnext167</small>
                    </div>
                    <small class="type-subtitle text-foreground-accent opacity-50 block">Discord</small>
                  </div>
                  <div>
                    ...
                    <p class="type-paragraph text-foreground-accent">Very satisfied with the scripts i've purchased, and support is great and very helpful!</p>
                  </div>
                </div>
                <div class="bg-background rounded p-lg grid gap-md flex-[1_1_300px] grid-rows-[auto_1fr]">
                  <div class="flex gap-md items-center">
                    <img src="https://media.discordapp.net/attachments/1049749773185470537/1135266178688876595/avatar.png" alt="Avatar of chiooky" class="rounded-sm h-12">
                    <div class="flex-grow">
                      <h3 class="type-header block leading-none">chiooky</h3>
                      <small class="type-subtitle text-foreground-accent opacity-50 block">@chiooky</small>
                    </div>
                    <small class="type-subtitle text-foreground-accent opacity-50 block">Discord</small>
                  </div>
                  <div>
                    ...
                    <p class="type-paragraph text-foreground-accent">There are 4 Discord servers on which I am active. And more often look and this one is the nr.5 never where uncomplicated something done like here. Thanks for that. </p>
                  </div>
                </div>
              </div>
            </section>
