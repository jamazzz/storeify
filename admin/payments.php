            ...
            <div class="card-body">
              ...
              <table class="table table-responsive-sm table-striped table-responsive-md">
                ...
                <tbody>
                  ...
                  $select2 = "SELECT * FROM transactions WHERE payer_email LIKE '%$filter%' 
                  ...
                  while ($row2 = mysqli_fetch_assoc($result2)) {
                    ...
                    echo ('
                        <td class="text-end">
                          <form action="/storeify/admin/payments-info.php" method="POST">
...
<td class="text-end">
                          <form action="/storeify/admin/delete.php" method="POST">
                            <input type="hidden" name="paymentID" value="' . $row2['id'] . '">
